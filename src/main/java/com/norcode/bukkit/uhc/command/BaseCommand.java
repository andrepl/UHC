...
public class BaseCommand implements TabExecutor {
	...
	public BaseCommand(JavaPlugin plugin, String name, String[] aliases, String requiredPermission, String[] help) {
		this.plugin = plugin;
		this.name = name;
	...
	protected void showHelp(CommandSender sender, String label, LinkedList<String> args) {
		...
		if (subcommands.size() > 0) {
			sender.sendMessage("Subcommands: " + StringUtils.join(filterByPermission(sender, subcommands).keySet(), ", "));
		}
	}
